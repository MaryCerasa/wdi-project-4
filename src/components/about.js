  ...
  render() {
    return (
      <div className="aboutPage">
        ...
        <p>Guests can stay up to date with relevant news provided by the NHS or write posts about their experiences and recieve positive encouragemenrt and support from their peers as well as seek advice from practicing therapists and mental health professionals through verified accounts.</p>
      </div>
    )
  }
}
